...
- name: USAJobs API
  description: Federal, state, and local government agencies are hiring and have thousands
    of job openings across the country, posted on USAJobs
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/usajobs.png
  humanURL: ""
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/usajobs-api/master/_listings/usajobs-api/jobs-search-json-get.md
x-common:
- type: x-website
